...
def production_trading_service(db_factory, fake_redis_client, production_warden):
    ...
    including the wired Warden. halt_checker injected as no-op since
    the gate under test in this file is the Warden, not Wire halts."""
    run_agents = importlib.import_module("scripts.run_agents")
...
async def test_warden_missing_branch_rejects_and_alerts(
    ...
    # halt_checker is injected (the gate under test is Warden, not halts).
